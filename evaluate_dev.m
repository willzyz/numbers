...
weightcost = 0; 
figure; 
progress = [1e4:1e4:5e5]; 
path = '/afs/cs/u/wzou/nbr/development_savemodel/'; 

% --- write script to evaluate acc and weber ratio on a progression ---
for iteration = progress 
    count = 1; 
    figure 
    for reference_nbr = ref_nbrs %[1e-6, 1e-7, 1e-10, 1e-20, 1e-30] %[0.1, 0.01, 0.001, 0.0001, 0.00001] % 
        params_filename = sprintf([path, 'devsave_exp%d_iter%d.mat'], netconfig.exp_count, iteration); 
